...
@InputType()
class ContractCreateNestedManyWithoutCustomersInput {
...
export { ContractCreateNestedManyWithoutCustomersInput as ContractCreateNestedManyWithoutCustomersInput };
