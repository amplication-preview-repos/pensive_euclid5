...
@InputType()
class ContractCreateNestedManyWithoutSuppliersInput {
...
export { ContractCreateNestedManyWithoutSuppliersInput as ContractCreateNestedManyWithoutSuppliersInput };
