...
@InputType()
class ComplianceDocumentUpdateManyWithoutTrucksInput {
...
export { ComplianceDocumentUpdateManyWithoutTrucksInput as ComplianceDocumentUpdateManyWithoutTrucksInput };
